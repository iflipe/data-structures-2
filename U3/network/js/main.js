...
function setupGUI(config) {
	...
	// Colours
	if (config.legend.nodeLabel) {
		$(".colours").next().html("<div style='text-align:center;width:80%;height:16px;border:none;padding:3px 0;background:rgb(223,137,255);display:block;margin-left:20px'><b>Eddard</b></div>"+
            "<div style='text-align:center;width:80%;height:16px;border:none;padding:3px 0;background:rgb(115,192,0);display:block;margin-left:20px'><b>Catelyn</b></div>"+
            "<div style='text-align:center;width:80%;height:16px;border:none;padding:3px 0;background:rgb(0,196,255);display:block;margin-left:20px'><b>Tyrion</b></div>"+
            "<div style='text-align:center;color:white;width:80%;height:16px;border:none;padding:3px 0;background:rgb(76,70,62);display:block;margin-left:20px'><b>Daenerys</b></div>"+
            "<div style='text-align:center;width:80%;height:16px;border:none;padding:3px 0;background:rgb(255,85,132);display:block;margin-left:20px'><b>Jon</b></div>"+    
            "<div style='text-align:center;width:80%;height:16px;border:none;padding:3px 0;background:rgb(255,136,5);display:block;margin-left:20px'><b>Sansa</b></div>"+
            "<div style='text-align:center;width:80%;height:16px;border:none;padding:3px 0;background:rgb(0,189,148);display:block;margin-left:20px'><b>Bran</b></div>"+
            "<div style='text-align:center;width:80%;height:16px;border:none;padding:3px 0;background:rgb(211,179,176);display:block;margin-left:20px'><b>Arya</b></div>"+
            "<div style='text-align:center;width:80%;height:16px;border:none;padding:3px 0;background:rgb(255,255,255);display:block;margin-left:20px'><b>More than 1</b></div>");
	} else {
		//hide more information link
		$(".colours").hide();
	}
